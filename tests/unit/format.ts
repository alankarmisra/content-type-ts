...
import { format } from '../../src/index'; // Adjust the import path as necessary

describe('formatMediaType(obj)', function () {
  ...
  it('should require argument', function () {
    assert.throws(format.bind(null), /Invalid media type/)
  })

  it('should reject non-objects', function () {
    assert.throws(format.bind(null, 7 as any), /Invalid media type/)
  })

  it('should require type', function () {
    var obj = {}
    assert.throws(format.bind(null, obj as any), /Invalid media type/)
  })

  it('should reject invalid type', function () {
    var obj = { type: 'text/' }
    assert.throws(format.bind(null, obj), /Invalid media type/)
  })
